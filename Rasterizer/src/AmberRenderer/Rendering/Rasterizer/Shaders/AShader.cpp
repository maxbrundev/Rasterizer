...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetUniformInt(const std::string_view p_name, int p_value)
{
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetUniformFloat(const std::string_view p_name, float p_value)
{
	ShaderData& shaderData = m_uniforms[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetUniformVec2(const std::string_view p_name, const glm::vec2& p_value)
{
	ShaderData& shaderData = m_uniforms[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetUniformVec3(const std::string_view p_name, const glm::vec3& p_value)
{
	ShaderData& shaderData = m_uniforms[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetUniformVec4(const std::string_view p_name, const glm::vec4& p_value)
{
	ShaderData& shaderData = m_uniforms[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetUniformMat2(const std::string_view p_name, const glm::mat2& p_value)
{
	ShaderData& shaderData = m_uniforms[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetUniformMat3(const std::string_view p_name, const glm::mat3& p_value)
{
	ShaderData& shaderData = m_uniforms[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetUniformMat4(const std::string_view p_name, const glm::mat4& p_value)
{
	ShaderData& shaderData = m_uniforms[p_name];
...
int AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetUniformAsInt(const std::string_view p_name) const
{
...
float AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetUniformAsFloat(const std::string_view p_name) const
{
	auto it = m_uniforms.find(p_name);
...
glm::vec2 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetUniformAsVec2(const std::string_view p_name) const
{
	auto it = m_uniforms.find(p_name);
...
glm::vec3 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetUniformAsVec3(const std::string_view p_name) const
{
	auto it = m_uniforms.find(p_name);
...
glm::vec4 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetUniformAsVec4(const std::string_view p_name) const
{
	auto it = m_uniforms.find(p_name);
...
glm::mat2 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetUniformAsMat2(const std::string_view p_name) const
{
	auto it = m_uniforms.find(p_name);
...
glm::mat3 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetUniformAsMat3(const std::string_view p_name) const
{
	auto it = m_uniforms.find(p_name);
...
glm::mat4 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetUniformAsMat4(const std::string_view p_name) const
{
	auto it = m_uniforms.find(p_name);
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetFlatInt(const std::string_view p_name, int p_value)
{
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetFlatFloat(const std::string_view p_name, float p_value)
{
	ShaderData& shaderData = m_flats[p_name];
	shaderData.Type = EShaderDataType::FLOAT;
	shaderData.Data[0] = p_value;
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetFlatVec2(const std::string_view p_name, const glm::vec2& p_value)
{
	ShaderData& shaderData = m_flats[p_name];
	shaderData.Type = EShaderDataType::VEC2;
	CopyFloats(shaderData.Data, glm::value_ptr(p_value), 2);
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetFlatVec3(const std::string_view p_name, const glm::vec3& p_value)
{
	ShaderData& shaderData = m_flats[p_name];
	shaderData.Type = EShaderDataType::VEC3;
	CopyFloats(shaderData.Data, glm::value_ptr(p_value), 3);
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetFlatVec4(const std::string_view p_name, const glm::vec4& p_value)
{
	ShaderData& shaderData = m_flats[p_name];
	shaderData.Type = EShaderDataType::VEC4;
	CopyFloats(shaderData.Data, glm::value_ptr(p_value), 4);
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetFlatMat2(const std::string_view p_name, const glm::mat2& p_value)
{
	ShaderData& shaderData = m_flats[p_name];
	shaderData.Type = EShaderDataType::MAT2;
	CopyFloats(shaderData.Data, glm::value_ptr(p_value), 4);
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetFlatMat3(const std::string_view p_name, const glm::mat3& p_value)
{
	ShaderData& shaderData = m_flats[p_name];
	shaderData.Type = EShaderDataType::MAT3;
	CopyFloats(shaderData.Data, glm::value_ptr(p_value), 9);
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetFlatMat4(const std::string_view p_name, const glm::mat4& p_value)
{
	ShaderData& shaderData = m_flats[p_name];
	shaderData.Type = EShaderDataType::MAT4;
	CopyFloats(shaderData.Data, glm::value_ptr(p_value), 16);
...
int AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetFlatAsInt(const std::string_view name) const
{
...
float AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetFlatAsFloat(const std::string_view p_name) const
{
...
glm::vec2 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetFlatAsVec2(const std::string_view p_name) const
{
	auto it = m_flats.find(p_name);
...
glm::vec3 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetFlatAsVec3(const std::string_view p_name) const
{
	auto it = m_flats.find(p_name);
...
glm::vec4 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetFlatAsVec4(const std::string_view p_name) const
{
	auto it = m_flats.find(p_name);
...
glm::mat2 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetFlatAsMat2(const std::string_view p_name) const
{
	auto it = m_flats.find(p_name);
...
glm::mat3 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetFlatAsMat3(const std::string_view p_name) const
{
	auto it = m_flats.find(p_name);
...
glm::mat4 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetFlatAsMat4(const std::string_view p_name) const
{
	auto it = m_flats.find(p_name);
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetVaryingInt(const std::string_view p_name, int p_value, uint8_t p_vertexIndex)
{
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetVaryingFloat(const std::string_view p_name, float p_value, uint8_t p_vertexIndex)
{
	if (p_vertexIndex == 255) p_vertexIndex = m_vertexIndex;
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetVaryingVec2(const std::string_view p_name, const glm::vec2& p_value, uint8_t p_vertexIndex)
{
	if (p_vertexIndex == 255) p_vertexIndex = m_vertexIndex;
	ShaderVarying& shaderVarying = m_varyings[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetVaryingVec3(const std::string_view p_name, const glm::vec3& p_value, uint8_t p_vertexIndex)
{
	if (p_vertexIndex == 255) p_vertexIndex = m_vertexIndex;
	ShaderVarying& shaderVarying = m_varyings[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetVaryingVec4(const std::string_view p_name, const glm::vec4& p_value, uint8_t p_vertexIndex)
{
	if (p_vertexIndex == 255) p_vertexIndex = m_vertexIndex;
	ShaderVarying& shaderVarying = m_varyings[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetVaryingMat2(const std::string_view p_name, const glm::mat2& p_value, uint8_t p_vertexIndex)
{
	if (p_vertexIndex == 255) p_vertexIndex = m_vertexIndex;
	ShaderVarying& shaderVarying = m_varyings[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetVaryingMat3(const std::string_view p_name, const glm::mat3& p_value, uint8_t p_vertexIndex)
{
	if (p_vertexIndex == 255) p_vertexIndex = m_vertexIndex;
	ShaderVarying& shaderVarying = m_varyings[p_name];
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetVaryingMat4(const std::string_view p_name, const glm::mat4& p_value, uint8_t p_vertexIndex)
{
	if (p_vertexIndex == 255) p_vertexIndex = m_vertexIndex;
	ShaderVarying& shaderVarying = m_varyings[p_name];
...
int AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetVaryingAsInt(const std::string_view p_name) const
{
...
float AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetVaryingAsFloat(const std::string_view p_name) const
{
	auto it = m_varyings.find(p_name);
...
glm::vec2 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetVaryingAsVec2(const std::string_view p_name) const
{
	auto it = m_varyings.find(p_name);
...
glm::vec3 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetVaryingAsVec3(const std::string_view p_name) const
{
	auto it = m_varyings.find(p_name);
	if (it == m_varyings.end()) 
		return glm::vec3(0.0f);
...
glm::vec4 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetVaryingAsVec4(const std::string_view p_name) const
{
	auto it = m_varyings.find(p_name);
...
glm::mat2 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetVaryingAsMat2(const std::string_view p_name) const
{
	auto it = m_varyings.find(p_name);
...
glm::mat3 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetVaryingAsMat3(const std::string_view p_name) const
{
	auto it = m_varyings.find(p_name);
...
glm::mat4 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetVaryingAsMat4(const std::string_view p_name) const
{
	auto it = m_varyings.find(p_name);
...
void AmberRenderer::Rendering::Rasterizer::Shaders::AShader::SetSample(const std::string_view p_name, Resources::Texture* p_texture)
{
	m_samples[p_name] = p_texture;
}

AmberRenderer::Resources::Texture* AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetSample(const std::string_view p_name) const
{
...
int AmberRenderer::Rendering::Rasterizer::Shaders::AShader::GetTypeCount(EShaderDataType p_type)
{
	switch (p_type)
	{
...
glm::vec4 AmberRenderer::Rendering::Rasterizer::Shaders::AShader::Texture(const Resources::Texture& p_texture, const glm::vec2& p_texCoords) const
{
