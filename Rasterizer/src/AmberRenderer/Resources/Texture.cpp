...
AmberRenderer::Resources::Texture::Texture(std::string p_filePath, uint32_t p_width, uint32_t p_height, uint32_t p_bitsPerPixel, unsigned char* p_data, Settings::ETextureFilteringMode p_filter, Settings::ETextureWrapMode p_wrapping, bool p_generateMipmap) :
...
AmberRenderer::Resources::Texture::~Texture()
{
	delete[] Data;
	Data = nullptr;
...
void AmberRenderer::Resources::Texture::GenerateMipmaps()
{
	int width  = Width;
	int height = Height;
