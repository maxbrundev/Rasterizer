...
std::string AmberRenderer::Tools::Utils::String::ExtractDirectoryFromPath(const std::string& p_path)
{
...
std::string AmberRenderer::Tools::Utils::String::ExtractFileNameFromPath(const std::string& p_path)
{
...
std::string AmberRenderer::Tools::Utils::String::RemoveExtensionFromFileName(const std::string& p_file)
{
...
bool AmberRenderer::Tools::Utils::String::Replace(std::string& p_target, const std::string& p_from, const std::string& p_to)
{
...
void AmberRenderer::Tools::Utils::String::ReplaceAll(std::string& p_target, const std::string& p_from, const std::string& p_to)
{
