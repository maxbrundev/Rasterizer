#include "AmberRenderer/Context/Device.h"

#include <stdexcept>
#include <SDL2/SDL.h>

AmberRenderer::Context::Device::Device()
{
	InitializeSDL();
}

void AmberRenderer::Context::Device::InitializeSDL()
{
...
void AmberRenderer::Context::Device::PollEvents()
{
...
void AmberRenderer::Context::Device::SetRelativeMouseMode(bool p_value)
{
	SDL_SetRelativeMouseMode(p_value ? SDL_TRUE : SDL_FALSE);
}

bool AmberRenderer::Context::Device::GetRelativeMouseMode()
{
	return SDL_GetRelativeMouseMode();
}

uint32_t AmberRenderer::Context::Device::GetTicks() const
{
	return SDL_GetTicks();
}
