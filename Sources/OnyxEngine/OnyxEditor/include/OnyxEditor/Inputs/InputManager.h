...
#include "OnyxEditor/Inputs/EKey.h"
#include "OnyxEditor/Inputs/EKeyState.h"
#include "OnyxEditor/Inputs/EMouseButton.h"
#include "OnyxEditor/Inputs/EMouseButtonState.h"

namespace OnyxEditor::Inputs
{
	class InputManager
	{
	public:
