...
OnyxEditor::Context::Window::Window(Device& p_device, const Settings::WindowSettings& p_windowSettings) :
m_device(p_device),
m_sdlWindow(nullptr),
...
OnyxEditor::Context::Window::~Window()
{
	SDL_DestroyWindow(m_sdlWindow);
}

void OnyxEditor::Context::Window::CreateSDLWindow()
{
...
void OnyxEditor::Context::Window::OnResizeWindow(uint16_t p_width, uint16_t p_height)
{
	int width;
	int height;
...
void OnyxEditor::Context::Window::UpdateWindowSurface() const
{
	SDL_UpdateWindowSurface(m_sdlWindow);
}

void OnyxEditor::Context::Window::SetClose()
{
	m_isActive = false;
}

void OnyxEditor::Context::Window::SetCursorMode(Settings::ECursorMode p_cursorMode)
{
	m_cursorMode = p_cursorMode;
	SDL_ShowCursor(static_cast<int>(p_cursorMode));
}

OnyxEditor::Context::Settings::ECursorMode OnyxEditor::Context::Window::GetCursorMode() const
{
	return m_cursorMode;
}

void OnyxEditor::Context::Window::SetSize(uint16_t p_width, uint16_t p_height)
{
...
uint32_t OnyxEditor::Context::Window::GetWindowFlags() const
{
	return SDL_GetWindowFlags(m_sdlWindow);
}

void OnyxEditor::Context::Window::Restore() const
{
	SDL_RestoreWindow(m_sdlWindow);
}

void OnyxEditor::Context::Window::Hide() const
{
	SDL_HideWindow(m_sdlWindow);
}

bool OnyxEditor::Context::Window::IsActive() const
{
	return m_isActive;
}

bool OnyxEditor::Context::Window::isFullscreen() const
{
	return m_isFullscreen;
}

SDL_Window* OnyxEditor::Context::Window::GetSDLWindow() const
{
	return m_sdlWindow;
}

float OnyxEditor::Context::Window::GetAspectRatio() const
{
	return m_aspectRatio;
}

const std::pair<uint16_t, uint16_t>& OnyxEditor::Context::Window::GetSize() const
{
	return m_size;
}