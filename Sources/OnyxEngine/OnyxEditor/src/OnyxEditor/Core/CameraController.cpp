...
OnyxEditor::Core::CameraController::CameraController(Entities::Camera& p_camera, glm::vec3& p_position, glm::quat& p_rotation) :
...
void OnyxEditor::Core::CameraController::Update(float p_deltaTime)
{
...
void OnyxEditor::Core::CameraController::HandleMouse()
{
...
void OnyxEditor::Core::CameraController::SetPosition(const glm::vec3& p_position) const
{
	m_position = p_position;
}

void OnyxEditor::Core::CameraController::SetPosition(float p_posX, float p_posY, float p_posZ) const
{
	m_position.x = p_posX;
	m_position.y = p_posY;
	m_position.z = p_posZ;
...
const glm::vec3& OnyxEditor::Core::CameraController::GetPosition() const
{
	return m_position;
}

bool OnyxEditor::Core::CameraController::IsRightMousePressed() const
{
	return m_rightMousePressed;
}

void OnyxEditor::Core::CameraController::SetRotation(const glm::quat& p_rotation) const
{
	m_rotation = p_rotation;
}

const glm::quat& OnyxEditor::Core::CameraController::GetRotation() const
{
	return m_rotation;
}

void OnyxEditor::Core::CameraController::SetSpeed(float p_value)
{
	m_moveSpeed = p_value;
}

float OnyxEditor::Core::CameraController::GetSpeed() const
{
	return m_moveSpeed;
}

void OnyxEditor::Core::CameraController::HandleInputs(float p_deltaTime)
{
...
void OnyxEditor::Core::CameraController::HandleCameraZoom() const
{
