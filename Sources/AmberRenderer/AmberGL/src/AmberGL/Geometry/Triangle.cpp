...
AmberGL::Geometry::Triangle::Triangle(const glm::vec2& p_vertex0, const glm::vec2& p_vertex1, const glm::vec2& p_vertex2) : Vertices{ p_vertex0, p_vertex1, p_vertex2 }
{
...
void AmberGL::Geometry::Triangle::PreComputeBarycentricCoordinates()
{
...
glm::vec3 AmberGL::Geometry::Triangle::GetBarycentricCoordinates(const glm::vec2& p_vertex) const
{
...
float AmberGL::Geometry::Triangle::ComputeEdge(const glm::vec2& p_vertex0, const glm::vec2& p_vertex1, const glm::vec2& p_vertex2) const
{
	return (p_vertex1.x - p_vertex0.x) * (p_vertex2.y - p_vertex0.y) - (p_vertex1.y - p_vertex0.y) * (p_vertex2.x - p_vertex0.x);
}

float AmberGL::Geometry::Triangle::ComputeArea() const
{
