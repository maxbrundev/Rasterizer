...
std::string AmberEditor::Tools::Utils::String::ExtractDirectoryFromPath(const std::string& p_path)
{
...
std::string AmberEditor::Tools::Utils::String::ExtractFileNameFromPath(const std::string& p_path)
{
...
std::string AmberEditor::Tools::Utils::String::RemoveExtensionFromFileName(const std::string& p_file)
{
...
bool AmberEditor::Tools::Utils::String::Replace(std::string& p_target, const std::string& p_from, const std::string& p_to)
{
...
void AmberEditor::Tools::Utils::String::ReplaceAll(std::string& p_target, const std::string& p_from, const std::string& p_to)
{
