...
glm::vec4 AmberEditor::Resources::Shaders::QuadNDC::VertexPass(const AmberGL::Geometry::Vertex& p_vertex)
{
...
glm::vec4 AmberEditor::Resources::Shaders::QuadNDC::FragmentPass()
{
