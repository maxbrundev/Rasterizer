...
AmberEditor::Resources::Shaders::ShadowMapping::ShadowMapping()
{
	...
	RegisterUniform("u_DepthMap", AmberGL::SoftwareRenderer::Programs::Sampler2D(1));
	RegisterUniform("u_lightPos", glm::vec3(0.0f, 0.0f, 0.0f));
}

glm::vec4 AmberEditor::Resources::Shaders::ShadowMapping::VertexPass(const AmberGL::Geometry::Vertex& p_vertex)
{
...
glm::vec4 AmberEditor::Resources::Shaders::ShadowMapping::FragmentPass()
{
