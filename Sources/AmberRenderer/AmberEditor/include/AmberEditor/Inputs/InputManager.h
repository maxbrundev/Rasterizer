...
#include "AmberEditor/Inputs/EKey.h"
#include "AmberEditor/Inputs/EKeyState.h"
#include "AmberEditor/Inputs/EMouseButton.h"
#include "AmberEditor/Inputs/EMouseButtonState.h"

namespace AmberEditor::Inputs
{
	class InputManager
	{
	public:
